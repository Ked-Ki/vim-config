...
syn keyword pentadactylCommand loadplugins lpl gr[oup] ! run Clistk[eys] Clk
    ...
    \ br[ewind] bf[irst] tgroup-d[elete] tgd tgroup-g[et] tgg tgroup-l[ist] tgl
    \ tgroup-mo[ve] tgm tgroup-n[ew] tgn tgroup-s[witch] tgs tgroup-t[itle] tgt
    \ time tlistk[eys] tlk tm[ap] tno[remap] toolbarh[ide] tbh[ide]
